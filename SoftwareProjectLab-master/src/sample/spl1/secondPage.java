...
public class secondPage {
    ...
    public Button getButton() throws FileNotFoundException {
        Image i = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/backArrow - Copy.png"));
    ...
    public void TheSecond(Stage stage) throws FileNotFoundException {
        ...
        Ab = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/experiment.png"));
        ...
        Ab2 = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/app.png"));
        ...
        Ab3 = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/spch.png"));
