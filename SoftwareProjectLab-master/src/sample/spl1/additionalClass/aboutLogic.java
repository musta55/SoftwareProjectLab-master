...
public class aboutLogic {
    ...
    public void aboutlogic(Stage stage) throws FileNotFoundException {
        ...
        Ab = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/algo.png"));
        ...
        Ab2 = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/person.png"));
    ...
    person per=new person();
        ...
        Ab3 = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/fuzzy.png"));
