   ...
   public String[] emotion = new String[85000];
    ...
    public void searchEmotion() throws IOException {
      ...
      //  System.out.println("Hey What's up");
        ...
        File files = new File("SoftwareProjectLab-master/src/sample/spl1/emotion.txt");
...
//            File myObj = new File(Name);
    ...
    public Button getButton() throws FileNotFoundException {
        Image i = new Image(new FileInputStream("SoftwareProjectLab-master/Pictures/backArrow - Copy.png"));
    ...
    public void VisualOutput(Stage stage,String status) throws FileNotFoundException {
        ...
        Image background = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/newbg.png"));
        Pane root = new Pane();
        back.setOnAction(e -> {
            try {
        ...
        Image happy = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/gif/happy.gif"));
        ...
        Image sad = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/gif/sad.gif"));
        ...
        Image disgust = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/gif/disgust.gif"));
        ...
        Image angry = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/gif/angry.gif"));
...
//                fp.runs(stage,accessToken,Name);
        ...
        Ab = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/fb.png"));
