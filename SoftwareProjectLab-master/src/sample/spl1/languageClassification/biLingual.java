...
public class biLingual {
    ...
    public void biLanguage()
    {
        ...
        try {
            ...
            Image Ab = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/enter.png"));
            ...
            Image backgrounds = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/newbg.png"));
...
public    biLingual(Stage primaryStage)
    {
        ...
        try {
            ...
            try {
                Text headning =textAtt();
                Image backgrounds = new Image(getClass().getClassLoader().getResource("SoftwareProjectLab-master/Pictures/newbg.png").toString(), true);
                Canvas canvas = new Canvas(1600,900);
                GraphicsContext gc = canvas.getGraphicsContext2D();
