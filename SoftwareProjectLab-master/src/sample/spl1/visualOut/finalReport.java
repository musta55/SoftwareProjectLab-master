...
public class finalReport {
    ...
    public Button getButton() throws FileNotFoundException {
        Image i = new Image(new FileInputStream("SoftwareProjectLab-master/Pictures/backArrow.png"));
    ...
    private void finalreport() throws FileNotFoundException {
        ...
        Image background = new Image(new FileInputStream("SoftwareProjectLab-master/src/Pictures/wheel.png"));
